function [Gamma_grid, Delta_grid]=
  GammaDelta(SpS, sz_grid, dr)
...
%              [n_y, n_x, n_z]
%  dr      - 1 X 3 array with gird spacing:
%              [dy, dx, dz]
% Outputs:
%   Gamma_grid - sz_grid X 3 array of full-width half-max resolutions in 
%                  all axis directions
...
%                  directions
    ...
    for i=1:3
        ...
        switch i
            case 1
                [~, R, ~]=...
                    meshgrid(1:sz_grid(1), 1:sz_grid(2), 1:sz_grid(3));
            case 2
                [R, ~, ~]=...
                    meshgrid(1:sz_grid(1), 1:sz_grid(2), 1:sz_grid(3));
            case 3
        ...
        Gamma_grid(:, :, :, i)=...
            sum(Xm_grid>=(max(Xm_grid, [], yesInd)/2), yesInd)*dr(i);
